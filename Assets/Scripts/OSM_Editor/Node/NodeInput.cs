...
namespace OSM
{
    public class NodeInput : NodeConnection
    {
        ...
        public virtual void Init(OSM_Node parent, bool multipleConnections = true)
        {
            base.Init(parent);
            name = "input";
        ...
        public override GUIStyle GetStyle()
        {
            if (_style == null) {
                ...
                _style.fixedHeight = kMinSize.y + OSM_Node.kKnobOffset;
        ...
        public static NodeInput Create(OSM_Node parent, bool multipleConnections = false)
        {
