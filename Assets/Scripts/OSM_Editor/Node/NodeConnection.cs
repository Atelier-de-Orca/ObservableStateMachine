...
namespace OSM
{
    public abstract class NodeConnection : ScriptableObject
    {
        ...
        public virtual void Init(OSM_Node parent)
        {
            name = "connection";
            parentNode = parent;
        }
        ...
        public virtual void OnConnectionGUI(int order)
        {
            ...
            // float yPos = parentNode.HeaderTop + order * GetStyle().fixedHeight + OSM_Node.kKnobOffset;
